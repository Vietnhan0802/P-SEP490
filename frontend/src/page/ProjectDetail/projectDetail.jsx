...
function ProjectDetail() {
    ...
    return (
        <div id="projectDetail" className='bg-white'>
            <h1 className='header fw-bold text-center'>
                UX review presentations
            </h1>
            <Row className='pb-5'>
                <Col md={6}>
                    <img src={projectImage} alt="project" className='w-100 ps-3' />
                </Col>
                <Col md={6}>
                    <div className='d-flex project'>
                        ...
                        <div className='width-auto d-flex align-items-center ps-3'>
                            <span className=' project-visibility d-flex align-items-center'><LuDot className='fs-3' />Public</span>
                        </div>
                        <div className='width-auto d-flex align-items-center ps-3'>
                            <span className=' project-status d-flex align-items-center fw-bold'><LuDot className='fs-3' />Pending</span>
                        </div>
                    </div>
                    <p className='project-description'>How do you create compelling presentations that wow your colleagues and impress your managers? Here’s how to get started.</p>
            ...
            <div className="member px-3">
                ...
                <table className='w-100'>
                    ...
                    <tr>
                        ...
                        <td className='w-60 py-3'>Lack of relevant and substantial information</td>
                        <td className='w-10 py-3 text-center  yellow-icon'><IoPersonRemove /></td>
                    </tr>
                    <tr>
                        <td className='w-20 py-3' >
                            <div className='d-flex align-items-center'>

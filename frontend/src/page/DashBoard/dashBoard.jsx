...
function DashBoard({ onSidebarClick }) {
  ...
  const [verificationAcceptedList, setVerificationAcceptedList] =
    useState(false);
  ...
  const verifiListLength =
    verificationAcceptedList?.length + verificationList?.length;
      ...
      case "verify":
        return (
          <VerifyTable
            ...
            verified={verificationAcceptedList}
            ...
            <Col md={12}>
              <Row className="bg-white cover">
                ...
                <Col md={4} className="px-0">
                  ...
                  >
                    ...
                    <div className="d-flex justify-content-between">
                      <p className="fs-24 fw-bold">
                        {ReportCount(
                          accountReportList?.length,
                          blogReportList?.length,
                ...
                <Col md={4} className="px-0">
                  <div
                    className={`card m-1 bg-white p-2 ${
                      activeTab === "verify" ? "active-tab" : ""
                    }`}
                  >
                    <div className="mb-1 fs-12">Manage Verification</div>
                    <div className="d-flex justify-content-between">
                      <p className="fs-24 fw-bold">
                        {verifiListLength > 0 ? verifiListLength : 0}{" "}
                        Verification{verifiListLength > 0 && "s"}
                      </p>
                    </div>
                    <hr style={{ margin: "0.5rem 0" }} />
                    <p
